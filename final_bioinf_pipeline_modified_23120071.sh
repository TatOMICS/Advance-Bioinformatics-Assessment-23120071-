...
# 6.1 Alignment of trimmed reads to hg19 reference genome, using Bowtie 2
cd ~/ngs_assesment_FINAL/dnaseq/data/trimmed_fastq
...
bowtie2-build ~/ngs_assesment_FINAL/dnaseq/data/Reference/hg19.fa.gz ~/ngs_assesment_FINAL/dnaseq/data/Reference/hg19_index

# Perform Alignment with Bowtie2
bowtie2 -p 4 -x ~/ngs_assesment_FINAL/dnaseq/data/Reference/hg19_index \
-1 NGS0001_chr22m_trimmed_R_1P \
-2 NGS0001_chr22m_trimmed_R_2P \
-S ~/ngs_assesment_FINAL/dnaseq/data/aligned_data/NGS0001.sam

# Convert SAM to BAM
samtools view -b -o ~/ngs_assesment_FINAL/dnaseq/data/aligned_data/NGS0001.bam ~/ngs_assesment_FINAL/dnaseq/data/aligned_data/NGS0001.sam

# Sort and Index BAM File
samtools sort -o ~/ngs_assesment_FINAL/dnaseq/data/aligned_data/NGS0001_sorted.bam ~/ngs_assesment_FINAL/dnaseq/data/aligned_data/NGS0001.bam
samtools index ~/ngs_assesment_FINAL/dnaseq/data/aligned_data/NGS0001_sorted.bam

# remove unneeded data to save disk space
rm ~/ngs_assesment_FINAL/dnaseq/data/aligned_data/NGS0001.sam
rm ~/ngs_assesment_FINAL/dnaseq/data/aligned_data/NGS0001.bam
